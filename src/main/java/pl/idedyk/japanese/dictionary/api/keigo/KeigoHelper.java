package pl.idedyk.japanese.dictionary.api.keigo;
...
public class KeigoHelper {
	...
	public KeigoHelper() {
		...
		addKeigoHighEntry(DictionaryEntryType.WORD_VERB_RU, "見る", "みる", "miru", KeigoEntryFindMatchType.END_WITH,
				DictionaryEntryType.WORD_VERB_U, "御覧", "になる", "ごらん", "になる", "goran", "ni naru", null, null, null);

		addKeigoHighEntry(DictionaryEntryType.WORD_VERB_RU, "見る", "みる", "miru", KeigoEntryFindMatchType.END_WITH,
				DictionaryEntryType.WORD_VERB_U, "ご覧", "に成る", "ごらん", "になる", "goran", "ni naru", null, null, null);

		addKeigoHighEntry(DictionaryEntryType.WORD_VERB_RU, "見る", "みる", "miru", KeigoEntryFindMatchType.END_WITH,
				DictionaryEntryType.WORD_VERB_U, "御覧", "に成る", "ごらん", "になる", "goran", "ni naru", null, null, null);
		
		// iu
		addKeigoHighEntry(DictionaryEntryType.WORD_VERB_U, "言う", "いう", "iu", KeigoEntryFindMatchType.END_WITH,
				DictionaryEntryType.WORD_VERB_U, "仰っしゃる", null, "おっしゃる", null, "ossharu", null, "仰っしゃい", "おっしゃい", "osshai");

		addKeigoHighEntry(DictionaryEntryType.WORD_VERB_U, "言う", "いう", "iu", KeigoEntryFindMatchType.END_WITH,
				DictionaryEntryType.WORD_VERB_U, "仰しゃる", null, "おっしゃる", null, "ossharu", null, "仰しゃい", "おっしゃい", "osshai");

		addKeigoHighEntry(DictionaryEntryType.WORD_VERB_U, "言う", "いう", "iu", KeigoEntryFindMatchType.END_WITH,
				DictionaryEntryType.WORD_VERB_U, "仰有る", null, "おっしゃる", null, "ossharu", null, "仰有い", "おっしゃい", "osshai");

		addKeigoHighEntry(DictionaryEntryType.WORD_VERB_U, "言う", "いう", "iu", KeigoEntryFindMatchType.END_WITH,
				DictionaryEntryType.WORD_VERB_U, "仰る", null, "おっしゃる", null, "ossharu", null, "仰い", "おっしゃい", "osshai");
		...
		addKeigoHighEntry(DictionaryEntryType.WORD_VERB_RU, "食べる", "たべる", "taberu", KeigoEntryFindMatchType.END_WITH,
				DictionaryEntryType.WORD_VERB_U, "召し上がる", null, "めしあがる", null, "meshi agaru", null, null, null, null);
		
		addKeigoHighEntry(DictionaryEntryType.WORD_VERB_RU, "食べる", "たべる", "taberu", KeigoEntryFindMatchType.END_WITH,
				DictionaryEntryType.WORD_VERB_U, "召上がる", null, "めしあがる", null, "meshi agaru", null, null, null, null);

		addKeigoHighEntry(DictionaryEntryType.WORD_VERB_RU, "食べる", "たべる", "taberu", KeigoEntryFindMatchType.END_WITH,
				DictionaryEntryType.WORD_VERB_U, "召し上る", null, "めしあがる", null, "meshi agaru", null, null, null, null);		
		
		addKeigoHighEntry(DictionaryEntryType.WORD_VERB_RU, "食べる", "たべる", "taberu", KeigoEntryFindMatchType.END_WITH,
				DictionaryEntryType.WORD_VERB_U, "召しあがる", null, "めしあがる", null, "meshi agaru", null, null, null, null);		
		...
		addKeigoLowEntry(DictionaryEntryType.WORD_VERB_RU, "食べる", "たべる", "taberu", KeigoEntryFindMatchType.END_WITH,
				DictionaryEntryType.WORD_VERB_U, "戴く", null, "いただく", null, "itadaku", null, null, null, null);
		...
		addKeigoLowEntry(DictionaryEntryType.WORD_VERB_U, null, "ある", "aru", KeigoEntryFindMatchType.END_WITH,
				DictionaryEntryType.WORD_VERB_U, "御座る", null, "ござる", null, "gozaru", null, "御座い", "ござい", "gozai");

		addKeigoLowEntry(DictionaryEntryType.WORD_VERB_U, null, "ある", "aru", KeigoEntryFindMatchType.END_WITH,
				DictionaryEntryType.WORD_VERB_U, "ご座る", null, "ござる", null, "gozaru", null, "ご座い", "ござい", "gozai");

		addKeigoLowEntry(DictionaryEntryType.WORD_VERB_U, null, "ある", "aru", KeigoEntryFindMatchType.END_WITH,
				DictionaryEntryType.WORD_VERB_U, "厶る", null, "ござる", null, "gozaru", null, "厶い", "ござい", "gozai");
		...
		addKeigoLowEntry(DictionaryEntryType.WORD_VERB_RU, null, "あげる", "ageru", KeigoEntryFindMatchType.EXACT,
				DictionaryEntryType.WORD_VERB_RU, "差し上げる", null, "さしあげる", null, "sashi ageru", null, null, null, null);

		addKeigoLowEntry(DictionaryEntryType.WORD_VERB_RU, null, "あげる", "ageru", KeigoEntryFindMatchType.EXACT,
				DictionaryEntryType.WORD_VERB_RU, "差上げる", null, "さしあげる", null, "sashi ageru", null, null, null, null);

		addKeigoLowEntry(DictionaryEntryType.WORD_VERB_RU, null, "あげる", "ageru", KeigoEntryFindMatchType.EXACT,
				DictionaryEntryType.WORD_VERB_RU, "さし上げる", null, "さしあげる", null, "sashi ageru", null, null, null, null);

		addKeigoLowEntry(DictionaryEntryType.WORD_VERB_RU, null, "あげる", "ageru", KeigoEntryFindMatchType.EXACT,
				DictionaryEntryType.WORD_VERB_RU, "差しあげる", null, "さしあげる", null, "sashi ageru", null, null, null, null);
		...
		addKeigoLowEntry(DictionaryEntryType.UNKNOWN, null, "です", "desu", KeigoEntryFindMatchType.END_WITH,
				DictionaryEntryType.WORD_VERB_U, "で御座る", null, "でござる", null, "de gozaru", null, "で御座い", "でござい", "de gozai");

		addKeigoLowEntry(DictionaryEntryType.UNKNOWN, null, "です", "desu", KeigoEntryFindMatchType.END_WITH,
				DictionaryEntryType.WORD_VERB_U, "でご座る", null, "でござる", null, "de gozaru", null, "でご座い", "でござい", "de gozai");

		addKeigoLowEntry(DictionaryEntryType.UNKNOWN, null, "です", "desu", KeigoEntryFindMatchType.END_WITH,
				DictionaryEntryType.WORD_VERB_U, "で厶る", null, "でござる", null, "de gozaru", null, "でご厶い", "でござい", "de gozai");
	...
	KeigoEntryFindMatchType findMatchType, DictionaryEntryType keigoDictionaryEntryType, String keigoKanji,
		...
		keigoWordToKeigoEntryHighMap.put(getKey(keigoKanji, keigoKanjiPostfix, keigoKana, keigoKanaPostfix), keigoEntry);
	}
