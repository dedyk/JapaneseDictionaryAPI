...
public class NounExampler {
	public static List<ExampleGroupTypeElements> makeAll(DictionaryEntry dictionaryEntry, 
		...
		// rozkaz
		GrammaExampleHelper.addExample(result, ExampleGroupType.NOUN_IMPERATIVE, makeImperativeExample(dictionaryEntry));
		
		// zakaz
		GrammaExampleHelper.addExample(result, ExampleGroupType.NOUN_IMPERATIVE_NOT, makeImperativeNotExample(dictionaryEntry));
